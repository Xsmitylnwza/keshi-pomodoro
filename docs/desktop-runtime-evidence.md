...
| G2 real session handoff | Pending deployed OAuth run | System-browser Google login; `persist:keshi` Domain cookie authenticates both domains; no renderer cookie copy | Pending |
